...
public class PartCQuestion_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<String> output_disjoint=
                        stream.assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<Tuple4<Integer, Integer, Long, String>>(Time.seconds(100)) {
  			      @Override
        		      public long extractTimestamp(Tuple4<Integer, Integer, Long, String> element) {
		...
		output_disjoint.writeAsText("/home/ubuntu/hw2_partc_dir/part_c_out_disjoint_allowlateness_100s");

		env.execute("Part-C Q2 Trial!");
	}
